...
if TYPE_CHECKING:
    ...
    from sqlalchemy.orm import Mapped, MapperProperty
    from sqlalchemy.orm.attributes import InstrumentedAttribute
    from sqlalchemy.sql.schema import Column
    from sqlalchemy.types import TypeEngine

    PropertyOrColumn: TypeAlias = MapperProperty | Column
    # PropertyOrColumn: TypeAlias = Mapped[Any] | sa.Column #SA 2.0
...
class ModelConverter:
    ...
    def property2field(
        self,
        prop: InstrumentedAttribute, #MapperProperty,
        *,
    ...
    @overload
    def column2field(
        self, column: sa.Column, *, instance: Literal[True] = ..., **kwargs
    ) -> fields.Field: ...

    @overload
    def column2field(
        self, column: sa.Column, *, instance: Literal[False] = ..., **kwargs
    ) -> type[fields.Field]: ...

    def column2field(
        self, column: sa.Column, *, instance: bool = True, **kwargs
    ) -> fields.Field | type[fields.Field]:
